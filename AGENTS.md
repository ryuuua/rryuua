...
- Sandbox automation: `bash /Users/ryua/code/mcp_sandbox/scripts/factory_auto.sh --token <TOKEN> --repo-id rryuua --repo-name rryuua --branch "$(git rev-parse --abbrev-ref HEAD)"`
